<template>
  <div>
    <b-form-group :label="labelText" :label-for="nameInput" :class="[size, {error}]">
      <b-form-input :name="nameInput" :type="typeInput" v-model="value" :required="isRequired" @change="validate(nameInput)"></b-form-input>
