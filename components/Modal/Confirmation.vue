  ...
  <div>
    <b-modal id="confirmation" :title="title" centered no-close-on-esc no-close-on-backdrop hide-footer
      ...
      <div class="mt-5 mb-2 d-flex justify-content-around">
        <b-button class="btn-grey lg" :disabled="isLoading" @click="$bvModal.hide('confirmation')">
          {{ isSuccess ? 'Fechar' : 'Cancelar' }}
        </b-button>
        <b-button @click="execute" variant="none" :disabled="isLoading" class="btn-purple lg ml-2">
